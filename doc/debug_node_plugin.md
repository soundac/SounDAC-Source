...
Anyone (even you!) can edit their account to contain 1 million XSD.  It's really
...
yourself 1 million XSD.  Just like it's really impossible for your bank to physically stop
...
the fake XSD or fake dollars you "gave" yourself).  So you can believe whatever you want
about your balance and rewrite the rules of your own bookkeeping system to show you whatever balance you
want to be shown, but as soon as you try to actually spend XSD (or dollars) that you don't actually have,
...
Now that we've reset its key, we can take control of it in the wallet:
    ...
    list_my_accounts
    transfer muse_test dantheman "1.234 2.28.0" "make -j100 money" true
    list_my_accounts
